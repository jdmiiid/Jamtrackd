...
class AlbumRatingPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final double selectedRating = ref.watch(currentDropdownProvider);
    final String selectedTrack = ref.watch(trackListDropdownProvider);
                                ...
                                Flexible(
                                  ...
                                  child: ButtonTheme(
                                    ...
                                    child: DropdownButton(
                                      ...
                                      onChanged: (track) {
                                        ref
                                            .read(trackListDropdownProvider
                                                .notifier)
                                            .update((state) => track!);
                                      },
                                    ),
